...
exports.planTripFromPrompt = void 0;
const prismaClient_1 = require("../../db/prismaClient");
const httpError_1 = require("../../utils/httpError");
const HOURS = 60 * 60 * 1000;
const buildStubPlan = (prompt) => {
...
const materializeEventDefinition = (baseStart, definition) => {
...
const planTripFromPrompt = async ({ prompt, userId }) => {
...
exports.planTripFromPrompt = planTripFromPrompt;
