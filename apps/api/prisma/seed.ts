  ...
  const venues = [
    {
      ...
      lat: 40.7703,
      lng: -73.9124,
      bookingType: 'manual',        // walk-in / manual contact
    ...
    },
    {
      ...
      lat: 40.7367,
      lng: -73.9967,
      bookingType: 'deeplink',      // assume OpenTable/Resy-style public booking
    ...
    },
    {
      ...
      lat: 40.7046,
      lng: -74.0107,
      bookingType: 'manual',        // group emails / forms
      bookingProvider: null,
    ...
    },
    {
      ...
      lat: 40.7440,
      lng: -73.9885,
      bookingType: 'deeplink',      // they use RSVPs & table reservations online
